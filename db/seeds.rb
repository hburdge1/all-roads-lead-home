...
item = Item.create(user_id: user.id, name: 'Flashlight', description: 'Illuminates the darkness')

Item.create(user_id: user.id, name: "Toby's jacket", description:'Something relevant will be in the pocket once I decide what it is')
...
_1a_7= Conversation.create(room_id: d_room.id, text: "You turn about-face and walk woodenly into the kitchen, sidling emotionlessly past your father who gladly rushes out of the room rather than handle you in this state. He shuts the door behind him and you are glad, at least, for the small favor of silence. You head to the sink and allow warm water to flow over your stinging hand, holding your breath at the shock. Why do I turn into a five-year-old again every time I come home? I’m so much better than this.
...
_1a_8 = Conversation.create(room_id: veranda.id, text: "You open your mouth to scream...")
# ************************Switch into loop 1b: conversations *********************

_1b_1 =  Conversation.create(room_id: m_basement.id, text: " *drip, drip, drip…*
...
_2a_1_b = Conversation.create(room_id: d_room.id, text: " \“Julie, my love, you look amazing! I can definitely tell that you’ve been taking good care of yourself out there\”, she tells you, though this time, you wonder if maybe she’s being honest.
...
_2a_2_5 = Conversation.create( room_id: d_room.id, text:" \“Actually,\” you call back, “I was just out there, and we still have plenty on the table.” 
...
#***Loop 1a choices***
_1a_1_a = Choice.create(conversation_id: _1a_1.id, text: 'Hunt in the dark for a flashlight, moving further from the exit',next_conversation_id: _1a_1_a_.id)

_1a_1_b = Choice.create(conversation_id: _1a_1.id, text: 'Find your way through the darkness to get to the basement door',next_conversation_id: _1a_2_5.id)

_1a_1_a__ = Choice.create(conversation_id: _1a_1_a_.id, text: 'Continue', next_conversation_id: _1a_2_5.id)

_1a_2_ = Choice.create(conversation_id: _1a_2_5.id, text: 'Continue', next_conversation_id: _1a_2.id)

_1a_2_a__ = Choice.create( conversation_id: _1a_2.id, text: 'Step outside to clear your head', next_conversation_id: _1a_2_a_5.id)

_1a_2_b_ = Choice.create(conversation_id: _1a_2.id, text: 'Bite the bullet, and go to the kitchen to see your parents', next_conversation_id: _1a_3.id,)

_1a_2_c_ = Choice.create(conversation_id: _1a_2.id, text: 'Work the room a bit in the hope of grabbing a drink', next_conversation_id: _1a_2_c_5.id)

_1a_2_a_5_ = Choice.create(conversation_id:  _1a_2_a_5.id, text: 'Continue', next_conversation_id: _1a_2_a.id)

_1a_2_a_3_ = Choice.create(conversation_id: _1a_2_a.id, text: 'Continue', next_conversation_id: _1a_3.id)

_1a_2_c_5_ = Choice.create(conversation_id: _1a_2_c_5.id, text: 'Continue', next_conversation_id: _1a_2_c.id)

_1a_2_c_ = Choice.create(conversation_id: _1a_2_c.id, text: 'Continue', next_conversation_id: _1a_3.id)

_1a_3__ = Choice.create(conversation_id: _1a_3.id, text: 'Continue', next_conversation_id: _1a_4.id)

_1a_4_ = Choice.create(conversation_id: _1a_4.id, text: 'Continue', next_conversation_id: _1a_5.id)

_1a_5__ = Choice.create(conversation_id: _1a_5.id, text: 'Continue', next_conversation_id: _1a_6_5.id)
_1a_5__ = Choice.create(conversation_id: _1a_6_5.id, text: 'Continue', next_conversation_id: _1a_6.id)

_1a_6_a = Choice.create( conversation_id: _1a_6.id, text: 'Rush into the kitchen to wash the blood from your hands',
next_conversation_id: _1a_7.id)

_1a_6_b = Choice.create(conversation_id: _1a_6.id, text: 'Head into the nearby closet to find the first-aid kit',
  next_conversation_id: _1a_6_b_.id)



_1a_6_b__ = Choice.create(conversation_id: _1a_6_b_.id, text: "Continue", next_conversation_id: _1a_7.id)

_1a_7__ = Choice.create(conversation_id: _1a_7.id, text: 'Continue', next_conversation_id: _1a_8.id)

_1a_8_ = Choice.create(conversation_id: _1a_8.id, text: 'Continue', next_conversation_id: _1b_1.id)



#**** Start loop 1b choices****
_1b_1_a_ = Choice.create(conversation_id: _1b_1.id, text: "Dig through the clutter for some clue of where you are", next_conversation_id: _1b_1_a_5.id)

_1b_1_b_ = Choice.create(conversation_id: _1b_1.id, text: "Investigate the exit and find the way out as fast as possible", next_conversation_id: _1b_1_b.id)


_1b_1_a_5_ = Choice.create(conversation_id: _1b_1_a_5.id, text: 'Continue', next_conversation_id: _1b_1_a.id)


_1b_1_a__ = Choice.create(conversation_id: _1b_1_a.id, text: 'Continue', next_conversation_id: _1b_2.id)

_1b_1_b__ = Choice.create(conversation_id: _1b_1_b.id, text: 'Continue', next_conversation_id:  _1b_2.id)

_1b_2_a = Choice.create(conversation_id: _1b_2.id, text: "The veranda", next_conversation_id: _1b_2_a_.id)

_1b_2_b = Choice.create(conversation_id: _1b_2.id, text: "The dining room", next_conversation_id: _1b_2_b_.id)

_1b_2_c = Choice.create(conversation_id: _1b_2.id, text: "The foyer", next_conversation_id: _1b_2_c_.id)

_1b_2_a__ = Choice.create(conversation_id: _1b_2_a_.id, text: 'Continue', next_conversation_id: _1b_2.id)

_1b_2_b__ = Choice.create(conversation_id: _1b_2_b_.id, text: 'Continue', next_conversation_id: _1b_3.id)

_1b_2_c__ = Choice.create(conversation_id: _1b_2_c_.id, text: 'Continue', next_conversation_id: _1b_2.id)
...
_2a_1_ = Choice.create(conversation_id: _2a_1.id, text: 'Continue', next_conversation_id: _2a_1_a.id)

_2a_1_a_ = Choice.create(conversation_id: _2a_1_a.id, text: 'Continue', next_conversation_id: _2a_1_b.id)

_2a_1_b_ = Choice.create(conversation_id: _2a_1_b.id, text: 'Continue', next_conversation_id: _2a_2.id)

_2a_2_ = Choice.create(conversation_id: _2a_2.id, text: 'Continue', next_conversation_id: _2a_2_5.id)


_2a_2_5 = Choice.create(conversation_id: _2a_2_5.id, text: 'Continue', next_conversation_id: _2a_2_a.id)

_2a_2_a_ = Choice.create(conversation_id: _2a_2_a.id, text: 'Continue', next_conversation_id: _2a_3.id)

_2a_3_ = Choice.create(conversation_id: _2a_3.id, text: 'Continue', next_conversation_id: _2a_3_a.id)

_2a_3_a_ = Choice.create(conversation_id: _2a_3_a.id, text: 'Continue', next_conversation_id: _2a_4.id)
