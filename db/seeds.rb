...
Item.create(
    user_id: user.id,
    name: "Toby's jacket",
    description: "Something relevant will be in the pocket once I decide what it is",
  )
...
convo1 =
  Conversation.create(room_id: basement.id, text: '*drip… drip… drip…*
