...
d_room = Room.create(name: 'Dining room', house_id: m_house.id)
...
_1a_5_= Conversation.create(room_id: d_room.id, text: "You turn about-face and walk woodenly into the kitchen, sidling emotionlessly past your father who gladly rushes out of the room rather than handle you in this state. He shuts the door behind him and you are glad, at least, for the small favor of silence. You head to the sink and allow warm water to flow over your stinging hand, holding your breath at the shock. Why do I turn into a five-year-old again every time I come home? I’m so much better than this.
