...
_1b_1_b_ = Conversation.create(room_id: m_basement.id, text: "You make a beeline for the door, nowhere near as careful as you should be as real panic sets in. Though the hazy confusion of this strange awakening, another feeling hits you hard in the gut— a deep sense of dread. You rush over to where the stairs should be and see that instead of a staircase upward, you’re staring down into a pit where the steps lead to a closed door. Descending slowly, you gently place your ear against the door, listening desperately for signs or life on the other side. You wait a moment… and then another moment… and then another, your heart sinking more with every second that ticks by. Finally, with a deep breath, you turn the knob and shove open the heavy door.")
...
_1a_1_b = Choice.create(conversation_id: _1a_1.id, text: 'Find your way through the darkness to get to the basement door',next_conversation_id: _1a_2.id)


_1a_1_a__ = Choice.create(conversation_id: _1a_1_a_.id, text: 'Continue', next_conversation_id: _1a_2.id)


_1a_2_a = Choice.create( conversation_id: _1a_2.id, text: 'Step outside to clear your head', next_conversation_id: _1a_2_a_.id)

_1a_2_b = Choice.create(conversation_id: _1a_2.id, text: 'Bite the bullet, and go to the kitchen to see your parents', next_conversation_id:  _1a_3.id,)

_1a_2_c = Choice.create(conversation_id: _1a_2.id, text: 'Work the room a bit in the hope of grabbing a drink',next_conversation_id:  _1a_2_c_.id)


_1a_2_a__ = Choice.create(conversation_id:  _1a_2_a_.id, text: 'Continue', next_conversation_id: _1a_3.id)


_1a_2_c__ = Choice.create(conversation_id: _1a_2_c_.id, text: 'Continue', next_conversation_id: _1a_3.id)
...
_1b_1_a__ = Choice.create(conversation_id: _1b_1_a_.id, text: 'Continue', next_conversation_id: _1b_2.id)

_1b_1_b__ = Choice.create(conversation_id: _1b_1_b_.id, text: 'Continue', next_conversation_id:  _1b_2.id)
